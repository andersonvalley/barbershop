...
function countNumbers() {
  ...
  var target = document.querySelector('.about__numbers');
...
function popupRegister() {
  ...
  document.addEventListener('click', function (e) {
    if (e.target.classList.contains('popup__overlay') || e.target.classList.contains('popup__close')) closePopup();
  });
}
...
function sliders() {
  var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.interior__slider', {
  ...
  var reviewsSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.reviews__list', {
    direction: 'horizontal',
    slidesOffsetAfter: 0,
    breakpoints: {
      320: {
  ...
  var welcome = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.meeting__slider', {
    direction: 'horizontal',
    spaceBetween: 10,
    breakpoints: {
      320: {
...
function loadYandeMap() {
  var src = "https://api-maps.yandex.ru/services/constructor/1.0/js/?um=constructor%3A194a616205bb3b02853d64f0f892b5dce840a29fdcebdd0d4862e684c356b896&amp;width=100%25&amp;height=630&amp;lang=ru_RU&amp;scroll=true\"></script>";
  var observer = new IntersectionObserver(trueCallback);
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_components_form__WEBPACK_IMPORTED_MODULE_8__.sendData)();
  (0,_components_sliders__WEBPACK_IMPORTED_MODULE_10__.sliders)();
